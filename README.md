...
**[Enumerable]** it is an application that uses methods to imitate the enumerable method
...
- **[Returns an answer if all the elements in a list fullfills a condition]**
- **[Returns an answer if any elements in a list fullfills a condition]**
